...
ESX.RegisterUsableItem('medikit', function(source)
	...
	TriggerClientEvent('esx:showNotification', _source, 'Käytit ~g~Ensiapupakkauksen~s~')
end)
...
ESX.RegisterUsableItem('bandage', function(source)
	...
	TriggerClientEvent('esx_ambulancejob:heal', _source, 'big')
	TriggerClientEvent('esx:showNotification', _source, 'Käytit ~g~Sideharson~s~')
end)
...
ESX.RegisterUsableItem('burana', function(source)
	...
	TriggerClientEvent('esx:showNotification', _source, 'Söit ~g~Buranan~s~')
end)
...
TriggerEvent('es:addGroupCommand', 'revive', 'admin', function(source, args, user)
	if args[1] ~= nil then
		if GetPlayerName(tonumber(args[1])) ~= nil then
			...
			TriggerClientEvent('esx_ambulancejob:revive', tonumber(args[1]))
			TriggerClientEvent('chatMessage', source, " REPORT ", {255, 0, 0}, "^3"..os.date("%X").."^0 | ^1"..GetPlayerName(source).."^0 nosti henkilön ^1"..GetPlayerName(args[1]))
				TriggerEvent("es:getPlayers", function(pl)
		for k,v in pairs(pl) do
			TriggerEvent("es:getPlayerFromId", k, function(user)
				if(user.getPermissions() > 0 and k ~= source)then
			TriggerClientEvent('chatMessage', k, " REPORT ", {255, 0, 0}, "^3"..os.date("%X").."^0 | ^1"..GetPlayerName(source).."^0 nosti henkilön ^1"..GetPlayerName(args[1]))
				end
			end)
		end
	end)
...
TriggerEvent('es:addGroupCommand', 'heal', 'admin', function(source, args, user)
	...
	TriggerClientEvent('chatMessage', source, "HEAL", {255, 0, 0}, "Sinulla ei ole oikeuksia tähän.")
